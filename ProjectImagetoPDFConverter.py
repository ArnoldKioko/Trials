...
class ImageToPDFConverter:
    ...
    def initialize_ui(self):
        title_label = tk.Label(self.root, text = "Image to PDF Converter 2 ", font = ("Helvetica",16,"bold" ) )
        ...
        convert_button =tk.Button(self.root, text = 'Convert to PDFs', command=self.convert_images_to_pdf)
    ...
    def convert_images_to_pdf(self):
        ...
        output_pdf_path = self.output_pdf_name() + '.pdf' if self.output_pdf_name.get() else 'output.pdf'
